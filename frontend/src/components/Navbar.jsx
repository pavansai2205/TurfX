...
const Navbar = () => {
  ...
  return (
    <>
      {/* Main header */}
      <header className="sticky top-0 z-40 w-full bg-[#f7f5ef]/95 backdrop-blur-xl border-b border-[#deded5] shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            
            {/* Logo with sleek athletic gradient TX badge */}
            <Link to="/" className="flex items-center gap-2.5 group">
              <div className="w-10 h-10 bg-sportsGreen rounded-lg flex items-center justify-center shadow-sm text-white font-extrabold text-lg tracking-tight select-none transform transition-transform group-hover:scale-105 duration-300">
                TX
              </div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <div className="text-left leading-tight hidden lg:block">
                        ...
                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">{user?.role ? user.role.replace('_', ' ') : ''}</p>
                      </div>
                    ...
                    {dropdownOpen && (
                      <div className="absolute right-0 mt-2 w-52 bg-white border border-[#deded5] rounded-xl shadow-xl py-1.5 z-50 animate-fadeIn space-y-0.5">
                        <Link 
                          to="/profile"
        ...
        {/* Mobile menu drawer */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-[#deded5] absolute top-full left-0 w-full p-6 space-y-4 shadow-xl z-50 animate-fadeIn">
            <Link 
              to="/browse" 
              ...
              <div className="border-t border-slate-100 pt-4 space-y-3">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">{user?.role ? user.role.replace('_', ' ') : ''}</p>
                  </div>
                </div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 z-40 w-full h-16 bg-[#f7f5ef]/95 backdrop-blur-lg border-t border-[#deded5] flex items-center justify-around px-2 pb-safe shadow-lg">
        <Link 
          to="/" 
